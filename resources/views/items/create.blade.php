...
<div class="row mb-3">
    <div class="col-md-12">
        <h2><i class="bi bi-box-seam"></i> Create New Item</h2>
    </div>
</div>
        ...
        <form action="{{ route('items.store') }}" method="POST">
            ...
            <div class="row">
                <div class="col-md-4 mb-3">
                    ...
                    <input type="text" class="form-control" name="unit" value="{{ old('unit') }}" placeholder="e.g., PCS, BOX, RIM" required>
                </div>
                <div class="col-md-4 mb-3">
                    <label class="form-label">Price <span class="text-danger">*</span></label>
                    <input type="number" class="form-control" name="price" value="{{ old('price', 0) }}" min="0" step="0.01" required>
                </div>
                <div class="col-md-4 mb-3">
